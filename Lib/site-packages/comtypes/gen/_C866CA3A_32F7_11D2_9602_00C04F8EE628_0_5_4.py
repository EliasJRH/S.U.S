...
__all__ = [
    ...
    'SPFM_CREATE', 'eLEXTYPE_RESERVED10',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechPhraseInfo',
    'STCInprocHandler', 'SPINTERFERENCE_TOOSLOW',
    'SAFT44kHz16BitMono', 'SRAONone', 'DISPID_SLGetWords',
    'SpeechCategoryAppLexicons', 'ISpeechPhraseReplacements',
    'DISPID_SRGSetTextSelection', 'SPCT_DICTATION',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEVENTENUM', 'SPPHRASEREPLACEMENT',
    'DISPIDSPTSI', 'SPLO_DYNAMIC', 'SpSharedRecognizer', 'SPPS_Noun',
    'DISPID_SpeechAudioFormat', 'SPRECORESULTTIMES',
    'DISPID_SRSCurrentStreamNumber', 'SPCATEGORYTYPE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechPhraseProperties',
    'SpeechAudioFormatGUIDWave', 'SPCT_SUB_COMMAND',
    'DISPID_SWFEBitsPerSample', 'DISPID_SLGetGenerationChange',
    'DISPID_SVEventInterests',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE9', 'SRAInterpreter', 'DISPID_SpeechPhraseRule',
    'eLEXTYPE_PRIVATE6', 'ISpeechLexiconPronunciation',
    'SAFT44kHz8BitMono', 'SAFT24kHz16BitStereo',
    'DISPID_SPRuleParent', 'ISpAudio', 'ISpNotifySink',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWsItem',
    'SP_VISEME_0', 'ISpeechRecognizerStatus', 'ISpeechGrammarRule',
    'SVPAlert', 'SVEAllEvents', 'SPPS_RESERVED4',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_16',
    'SAFT16kHz16BitMono', 'DISPID_SRCVoice',
    'DISPID_SVGetAudioOutputs', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRText',
    'DISPID_SPEActualConfidence', 'SECFIgnoreCase',
    'DISPID_SVGetProfiles', 'eWORDTYPE_DELETED', 'SGSDisabled',
    'SDA_No_Trailing_Space', 'Speech_Default_Weight',
    'SpeechRecognizerState', 'SVF_Emphasis', 'SPSERIALIZEDPHRASE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGetRecognizers',
    'DISPID_SMSALineId', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechDataKey', 'SVP_15', 'ISpeechLexiconWords',
    'SPSInterjection', 'DISPID_SVEViseme', 'DISPID_SVEStreamStart',
    'ISpEventSink', 'SpeechBookmarkOptions', 'SPSHORTCUTPAIR',
    'ISpStream', 'SBONone', 'DISPID_SRSCurrentStreamPosition',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCEHypothesis',
    'SVEVoiceChange', 'SPINTERFERENCE_TOOFAST', 'DISPID_SVResume',
    'SSFMCreateForWrite', 'STCRemoteServer', 'eLEXTYPE_PRIVATE2',
    'SAFT8kHz8BitStereo', 'ISpPhoneticAlphabetConverter',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SpeechPhraseAlternate',
    'SDA_One_Trailing_Space', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_INTERFERENCE',
    'DISPID_SWFEChannels', 'DISPID_SRRSaveToMemory', 'SPCS_DISABLED',
    'SpAudioFormat', 'DISPIDSPTSI_ActiveLength', 'SGRSTTRule',
    'SPEI_SR_AUDIO_LEVEL', 'SRESoundEnd', 'ISpResourceManager',
    'SPSERIALIZEDRESULT', 'SpeechEngineProperties', 'DISPID_SVVoice',
    'ISpeechDataKey', 'DISPID_SRRAlternates',
    'SpStreamFormatConverter', 'DISPID_SPEAudioStreamOffset',
    'SPDKL_CurrentUser', 'SPPROPERTYINFO', 'SPWORDPRONUNCIATION',
    'ISpeechMemoryStream', 'SVPNormal', 'DISPID_SLWType',
    'DISPID_SRCEStartStream', 'SLOStatic', 'IStream',
    'SpeechAddRemoveWord', 'DISPID_SGRsCount', 'SPFM_NUM_MODES',
    'SpeechVoiceSpeakFlags', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SOTsCount', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTADPCM_22kHzMono', 'UINT_PTR', 'DISPID_SGRAddState',
    'tagSTATSTG', 'DISPID_SLGetPronunciations',
    'DISPID_SRGCmdLoadFromFile',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', '_SPAUDIOSTATE',
    'SP_VISEME_5', 'SVP_4', 'SVP_13', 'DISPID_SGRsDynamic',
    'SVEViseme', 'SRSActive',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVEPhoneme',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVPause',
    'IEnumString', 'SpObjectToken', 'DISPID_SDKEnumValues',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechEngineConfidence', 'DISPID_SVSkip',
    'SREPropertyStringChange', 'SAFTGSM610_22kHzMono',
    'SREAdaptation', 'DISPID_SGRSTsItem',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVSLastBookmark',
    'SITooLoud', 'SPSHT_OTHER', 'SREFalseRecognition',
    'SPINTERFERENCE_NONE', 'DISPID_SBSFormat', 'DISPID_SGRSTWeight',
    'DISPID_SDKOpenKey', 'DISPID_SpeechPhraseElement',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE10',
    'IInternetSecurityMgrSite', 'DISPID_SADefaultFormat',
    'DISPID_SGRSTRule', 'SP_VISEME_21', 'eWORDTYPE_ADDED',
    'DISPID_SGRSAddWordTransition', 'SREPrivate',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechXMLRecoResult',
    'STCAll', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SBSWrite', 'DISPID_SpeechObjectToken',
    'DISPID_SPRuleChildren', 'ISpEventSource', 'SDTProperty',
    'SPVOICESTATUS', 'DISPID_SRCCmdMaxAlternates',
    'Speech_StreamPos_RealTime', 'SPAR_Low', 'SpeechCategoryAudioOut',
    'SAFT22kHz16BitStereo', 'SPEI_START_SR_STREAM',
    'SPEVENTSOURCEINFO', 'SGRSTTWord', 'DISPID_SVIsUISupported',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCPause',
    'eLEXTYPE_PRIVATE14', 'SPINTERFERENCE',
    'SpeechStreamSeekPositionType', 'SGRSTTDictation',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT11kHz16BitStereo',
    'DISPID_SPPValue', 'SBOPause', 'DISPID_SPAPhraseInfo',
    'DISPID_SRState', 'eLEXTYPE_RESERVED8', 'SpMMAudioEnum',
    'DISPID_SRSetPropertyNumber', 'Speech_StreamPos_Asap',
    'SPGRAMMARSTATE', 'SDTPronunciation', 'ISpeechPhraseAlternates',
    'DISPID_SRCEEndStream', 'ISpStreamFormat', 'SVEEndInputStream',
    'SpFileStream', 'ISpeechPhraseElement', 'DISPID_SRCESoundStart',
    'DISPID_SABIMinNotification', 'SP_VISEME_19', 'SRCS_Disabled',
    'ISpeechPhraseInfo', 'SVP_20', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechAudioStatus', 'DISPID_SRSetPropertyString',
    'ISpeechMMSysAudio', 'DISPID_SPCPhoneToId', 'DISPID_SBSRead',
    'DISPID_SVSpeak', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPRuleName',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRulesCount',
    'DISPID_SpeechRecoContext', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SGRSTText', 'SP_VISEME_11', 'SGRSTTTextBuffer',
    'SPGRAMMARWORDTYPE', 'SDTLexicalForm', 'SVSFNLPMask',
    'SP_VISEME_12', 'SECHighConfidence', 'DISPID_SOTIsUISupported',
    'SAFT48kHz8BitMono', 'DISPID_SRGState', 'SPRS_ACTIVE',
    'SAFT48kHz16BitMono', 'DISPID_SPRulesItem', 'SPSMF_UPS',
    'DISPID_SLPSymbolic', 'DISPID_SpeechRecognizer',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVSLastResult',
    'eLEXTYPE_LETTERTOSOUND', 'SWTDeleted',
    'DISPID_SOTGetStorageFileName', 'ISpPhraseAlt',
    'SpeechCategoryVoices', 'SITooSlow', 'SPEI_REQUEST_UI', 'SVP_3',
    'SpeechRegistryUserRoot', 'SpeechDataKeyLocation',
    'DISPID_SPRsCount', 'SpeechGrammarTagUnlimitedDictation',
    'SPEI_SR_BOOKMARK', 'DISPID_SRRSetTextFeedback',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGIsPronounceable',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLWLangId',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechObjectTokens',
    'ISpeechPhoneConverter', 'SpeechGrammarWordType', 'SPPHRASERULE',
    'SVSFPersistXML', 'DISPID_SGRSTPropertyName', 'SP_VISEME_20',
    'DISPID_SVSpeakCompleteEvent', 'SRADefaultToActive', 'SASClosed',
    'DISPID_SRGetFormat', 'SRAORetainAudio', 'DISPID_SDKDeleteValue',
    'SAFT48kHz8BitStereo', 'ISpeechPhraseProperty',
    'DISPID_SPPChildren', 'SPXMLRESULTOPTIONS', 'SPBO_PAUSE',
    'DISPID_SRSClsidEngine', 'SpeechWordType',
    'DISPID_SpeechVoiceEvent', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechLexicon', 'DISPID_SRGRecoContext', 'SPPS_LMA',
    'DISPID_SDKSetStringValue', 'DISPID_SPIProperties',
    'SAFT8kHz16BitStereo', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechFileStream', 'STSF_AppData', 'ISpRecognizer',
    'DISPID_SVEAudioLevel', 'DISPID_SDKGetlongValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_17',
    'DISPID_SPERetainedStreamOffset', 'SpeechRecoProfileProperties',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_PRIVATE16',
    'SpeechRuleState', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPPNumberOfElements', 'ISpeechRecoResult2', 'SPEI_VISEME',
    'SSTTTextBuffer', 'SPEI_RECO_STATE_CHANGE', 'SDTDisplayText',
    'SVEPrivate', 'DISPID_SLWPronunciations',
    'DISPID_SpeechRecoResult2', 'SAFT44kHz16BitStereo', 'SRAImport',
    'SGRSTTWildcard', 'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechFileStream',
    'tagSPPROPERTYINFO', 'SGDSActiveUserDelimited',
    'DISPID_SRAudioInput', 'SAFT32kHz8BitStereo', 'SPAR_Medium',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SGSExclusive',
    'SWPKnownWordPronounceable', 'SAFTNoAssignedFormat',
    'DISPID_SDKDeleteKey', 'SPAUDIOSTATUS',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEsItem',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPRS_INACTIVE',
    'DISPIDSPTSI_SelectionOffset', 'LONG_PTR', 'eLEXTYPE_PRIVATE3',
    'SAFTADPCM_11kHzStereo', 'ISpeechRecoGrammar', 'SP_VISEME_16',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SRGCmdLoadFromResource', 'SSSPTRelativeToCurrentPosition',
    'ISpeechRecoResultTimes', 'DISPID_SRGCmdLoadFromObject',
    'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpTextSelectionInformation', 'ISpRecoGrammar', 'SPEI_HYPOTHESIS',
    'DISPID_SASCurrentSeekPosition', 'SVP_18', 'ISpProperties',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTText', 'SRSInactiveWithPurge', 'SPEI_VOICE_CHANGE',
    'SVSFlagsAsync', 'DISPID_SPILanguageId',
    'DISPID_SASFreeBufferSpace', 'DISPID_SGRsItem', 'SPEI_RESERVED6',
    'DISPID_SVEVoiceChange', 'DISPID_SRCVoicePurgeEvent', 'SVP_19',
    'Speech_Max_Pron_Length', 'SpeechRuleAttributes',
    'DISPID_SPEEngineConfidence', 'SVSFIsXML',
    'DISPID_SWFESamplesPerSec', 'SPSMF_SAPI_PROPERTIES',
    'SSSPTRelativeToEnd', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechBaseStream', 'SVEBookmark', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCRecognizer', 'SAFTExtendedAudioFormat',
    'DISPID_SRGDictationSetState', 'SPPHRASEPROPERTY',
    'SSFMOpenReadWrite', 'SpeechTokenValueCLSID', 'SVPOver',
    'DISPID_SRCResume', 'SVEStartInputStream',
    '_ISpeechRecoContextEvents', 'SpeechPropertyResponseSpeed',
    'SPBO_NONE', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCEFalseRecognition', 'SGDSActive', 'SVP_10',
    'SRERecoOtherContext', 'SSTTWildcard', 'DISPID_SABIEventBias',
    'SPWT_PRONUNCIATION', 'SPEI_SOUND_START', 'DISPID_SPIElements',
    'DISPID_SVSVisemeId', 'DISPID_SGRSTransitions',
    'SPPS_Interjection', 'SFTInput', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechPhoneConverter', 'SpPhoneticAlphabetConverter',
    'DISPID_SAStatus', 'SPVPRI_OVER', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRSpeakAudio', 'SPVPRIORITY',
    'DISPID_SVESentenceBoundary', 'SpeechDictationTopicSpelling',
    'SpeechUserTraining', 'DISPID_SRRTimes', 'SP_VISEME_1',
    'eLEXTYPE_APP', 'SPEI_TTS_BOOKMARK', 'SPEI_SOUND_END', 'SPSNoun',
    'SPEI_TTS_PRIVATE', 'DISPID_SOTRemove', 'SpeechPartOfSpeech',
    'SPPS_RESERVED2', 'SPRST_INACTIVE', 'DISPID_SGRInitialState',
    'SDTAlternates', 'DISPID_SRCEventInterests',
    'SPADAPTATIONRELEVANCE', 'SGPronounciation', 'SPVPRI_ALERT',
    'DISPID_SPRuleEngineConfidence', 'SRADynamic',
    'DISPID_SOTMatchesAttributes', 'ISpObjectWithToken',
    'DISPID_SRRGetXMLResult', 'SPSNotOverriden', 'DISPID_SPAsItem',
    'SVEAudioLevel', 'DISPID_SRStatus', 'SP_VISEME_2', 'SINoise',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechVoice',
    'DISPID_SVSInputSentencePosition',
    'ISpeechGrammarRuleStateTransitions', 'SPAUDIOSTATE',
    'DISPID_SRRPhraseInfo', 'ISpGrammarBuilder', 'SPDATAKEYLOCATION',
    'SDKLCurrentUser', 'SP_VISEME_15',
    'DISPID_SPAStartElementInResult', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechVoice', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPBOOKMARKOPTIONS', 'SPEI_PHONEME', 'SPRS_ACTIVE_USER_DELIMITED',
    'SRTEmulated', 'DISPID_SPPParent', 'SREStateChange', 'SVP_9',
    'ISpNotifySource', 'DISPID_SLPsCount', 'DISPID_SVDisplayUI',
    'DISPID_SOTId', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SLWWord', 'SAFT12kHz16BitStereo', 'SPWT_LEXICAL',
    'SPFM_OPEN_READONLY', 'DISPID_SPAs_NewEnum',
    'SPRECOCONTEXTSTATUS', 'SAFTCCITT_ALaw_8kHzMono',
    'SPCONTEXTSTATE', 'SAFTCCITT_ALaw_44kHzStereo',
    'eLEXTYPE_PRIVATE7', 'SRSActiveAlways', 'DISPID_SOTCGetDataKey',
    'SITooQuiet', 'SPEI_MAX_TTS', 'ISpXMLRecoResult',
    'SpPhraseInfoBuilder', 'SITooFast', 'ISpRecognizer2',
    'SRTAutopause', 'SPPS_RESERVED1', 'DISPID_SOTs_NewEnum',
    'SpNullPhoneConverter', 'SVSFParseMask',
    'DISPID_SpeechLexiconWord', 'SpeechTokenIdUserLexicon',
    'SpeechLexiconType', 'SPLEXICONTYPE', 'ISpShortcut',
    'SpeechAudioFormatGUIDText', 'SVSFParseSsml', 'SPCT_COMMAND',
    'DISPID_SRCCreateGrammar', 'SPSTREAMFORMATTYPE',
    'SPXRO_Alternates_SML', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCERecognition', 'DISPID_SpeechGrammarRules',
    'ISpeechAudioStatus', 'SVP_5', 'DISPID_SPELexicalForm', 'SPEVENT',
    'DISPID_SPEPronunciation', 'DISPID_SpeechAudio',
    'DISPID_SRRAudio', 'DISPID_SVSRunningState', 'STCLocalServer',
    'SAFT8kHz16BitMono', 'DISPID_SRGetPropertyNumber',
    'SpeechMicTraining', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPISaveToMemory', 'DISPID_SRRAudioFormat',
    'STSF_LocalAppData', 'SPWORD', 'DISPIDSPTSI_SelectionLength',
    'SVSFParseSapi', 'DISPID_SGRs_NewEnum',
    'ISpeechTextSelectionInformation', 'SpInprocRecognizer',
    'SAFTCCITT_uLaw_8kHzStereo', 'SINone', 'SSSPTRelativeToStart',
    'DISPID_SPIAudioStreamPosition', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SLPsItem', 'SPRULE', 'SpCompressedLexicon',
    'DISPID_SRCESoundEnd', 'DISPID_SPARecoResult', 'SVSFUnusedFlags',
    'DISPID_SOTCDefault', 'SPAUDIOOPTIONS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVAlertBoundary',
    'DISPID_SGRSTPropertyId', 'SpeechTokenContext',
    'ISpeechGrammarRuleState', 'DISPIDSPRG', 'SPPS_Modifier',
    'SASStop', 'DISPID_SPPsCount', 'SPLOADOPTIONS',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechAudioBufferInfo',
    'eLEXTYPE_PRIVATE5', 'SWPUnknownWordPronounceable',
    'SPSSuppressWord', 'SPWAVEFORMATTYPE', 'SPRST_NUM_STATES',
    'SPSVerb', 'SPAO_NONE', 'ISpRecoGrammar2',
    'DISPID_SRCEInterference', 'SVP_21', 'ISpeechAudioBufferInfo',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEAdaptation', 'SRERecognition',
    'DISPID_SpeechPhraseElements', 'DISPID_SWFEExtraData',
    'DISPID_SVEWord', 'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE13',
    'DISPID_SMSAMMHandle', 'DISPIDSPTSI_ActiveOffset', 'SVP_7',
    'SAFTGSM610_11kHzMono', 'ISpeechPhraseReplacement',
    'SAFT24kHz8BitStereo', 'DISPID_SRRRecoContext', 'ISpPhrase',
    'DISPID_SRRTStreamTime', 'DISPID_SRCEEnginePrivate', 'SVP_11',
    'SAFT22kHz8BitStereo', 'ISpeechGrammarRules',
    'SpeechAudioProperties', 'DISPID_SRAudioInputStream',
    'DISPID_SRGDictationUnload', 'ISpeechObjectTokenCategory',
    'SGLexicalNoSpecialChars', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SDKSetBinaryValue', 'SAFT22kHz8BitMono',
    'SPWORDPRONOUNCEABLE', 'SAFT32kHz8BitMono', 'DISPID_SFSClose',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRGRules',
    'DISPID_SVVolume', 'SPSLMA', 'SAFT11kHz16BitMono',
    'SPEI_SR_PRIVATE', 'ISpObjectTokenCategory', 'DISPID_SGRsAdd',
    'STCInprocServer', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSTType', 'SP_VISEME_3', 'SREPhraseStart',
    'ISpeechLexiconWord', 'SpLexicon', 'ISpeechLexiconPronunciations',
    'SSFMCreate', 'SpResourceManager', 'DISPID_SRCState',
    'SP_VISEME_18', 'SREAllEvents', 'SVP_17', 'DISPID_SMSGetData',
    'SVP_0', 'SAFT16kHz16BitStereo', 'SpeechSpecialTransitionType',
    'ISpeechPhraseAlternate', 'SPINTERFERENCE_NOISE',
    'SpeechVoicePriority', 'SPEI_MIN_SR', 'DISPID_SLGenerationId',
    'DISPID_SPRules_NewEnum', 'SpObjectTokenCategory', 'SP_VISEME_9',
    'SSFMOpenForRead', 'DISPID_SpeechWaveFormatEx',
    'SPSEMANTICERRORINFO', 'SLODynamic', 'SP_VISEME_14',
    'eLEXTYPE_PRIVATE11', 'SpeechTokenKeyUI', 'STSF_CommonAppData',
    'SRESoundStart', 'SVESentenceBoundary',
    'SpeechTokenKeyAttributes', 'SAFTADPCM_22kHzStereo', 'SPSUnknown',
    'SPPS_Unknown', 'SPPARTOFSPEECH', 'SVEWordBoundary',
    'SAFT12kHz16BitMono', 'SVP_6', 'DISPID_SPPId', 'SVP_8',
    'ISpRecoResult', 'SREAudioLevel', 'DISPID_SOTCreateInstance',
    'SPWF_INPUT', 'SPSHT_NotOverriden', 'SpeechGrammarTagWildcard',
    'DISPID_SPIEngineId', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_RESERVED4', 'SLTUser', 'SPGS_EXCLUSIVE',
    'ISpObjectToken', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SVEBookmark', 'SECFIgnoreWidth', 'DISPID_SFSOpen',
    'DISPID_SGRAddResource', 'SECNormalConfidence',
    'SPAO_RETAIN_AUDIO', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPIGrammarId',
    'SPAS_PAUSE', 'DISPID_SPIRule', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SOTDisplayUI', 'SPPS_Noncontent',
    'DISPID_SRGCmdSetRuleState', 'SAFT11kHz8BitStereo',
    'ISpStreamFormatConverter', 'SAFTADPCM_8kHzStereo',
    'SpNotifyTranslator', 'SpStream', 'DISPID_SPEDisplayAttributes',
    'SpeechInterference', 'SAFTCCITT_ALaw_44kHzMono',
    'SPPS_SuppressWord', 'SPAS_CLOSED', 'SPTEXTSELECTIONINFO',
    'DISPID_SDKGetBinaryValue', 'SDTReplacement', 'SAFT11kHz8BitMono',
    'DISPID_SPRsItem', 'SVEPhoneme', 'SPSHT_Unknown',
    'SpeechTokenShellFolder', 'SWTAdded', 'DISPID_SDKGetStringValue',
    'STSF_FlagCreate', 'DISPID_SPAsCount', 'SP_VISEME_6',
    'SP_VISEME_8', 'SPSModifier', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SAEventHandle', 'eLEXTYPE_RESERVED7', 'SPEI_MIN_TTS',
    'DISPID_SPPName', 'SAFT48kHz16BitStereo', 'ISpeechBaseStream',
    'DISPID_SGRSAddSpecialTransition', 'eLEXTYPE_PRIVATE17',
    'ISpeechLexicon', 'ISpeechRecoResult', 'SP_VISEME_10',
    'DISPID_SRCBookmark', 'SPEI_RESERVED3',
    'DISPID_SpeechMemoryStream', 'SPEI_END_INPUT_STREAM',
    'SPBINARYGRAMMAR', 'SpUnCompressedLexicon', 'DISPID_SGRName',
    'SP_VISEME_13', 'SAFT12kHz8BitMono', 'SDKLDefaultLocation',
    'DISPID_SPPConfidence', 'ISpeechAudioFormat', 'ISpLexicon',
    'SRARoot', 'ISpeechGrammarRuleStateTransition',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SLWsCount',
    'DISPID_SRRTTickCount', 'DISPID_SVWaitUntilDone',
    'DISPID_SVGetVoices', 'DISPID_SPPs_NewEnum', 'SP_VISEME_7',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRGId', 'DISPID_SRGCommit',
    'DISPID_SLPLangId', 'SPINTERFERENCE_TOOLOUD',
    'SGDSActiveWithAutoPause', 'SDKLLocalMachine',
    'DISPID_SRRTLength', 'SASPause', 'SPSHORTCUTPAIRLIST',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SAVolume', 'SPRST_ACTIVE',
    'DISPID_SASetState', 'SPVISEMES', 'SVP_2', 'ISpeechObjectTokens',
    'SpeechPropertyAdaptationOn', 'SPFILEMODE',
    'SpeechDisplayAttributes', 'DISPID_SOTGetAttribute',
    'DISPID_SPEDisplayText', 'ISpeechPhraseProperties',
    'DISPID_SPPFirstElement', 'SpShortcut',
    'DISPID_SAFGetWaveFormatEx',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVP_12',
    'ISpSerializeState', 'SpPhoneConverter', 'SASRun',
    'DISPID_SVAudioOutputStream', 'WAVEFORMATEX',
    'DISPID_SpeechPhraseRules', 'SpInProcRecoContext',
    'SPEI_END_SR_STREAM', 'SDA_Two_Trailing_Spaces',
    ...
    'DISPID_SGRSTPropertyValue', 'DISPID_SWFEBlockAlign',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechVisemeType',
    'DISPID_SpeechPhraseBuilder', 'SVF_Stressed', 'SAFT24kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechRecoResultDispatch',
    'ISpeechCustomStream', 'DISPID_SpeechMMSysAudio',
    'SPEI_UNDEFINED', 'SpVoice', 'SVSFIsNotXML',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechLexiconPronunciation',
    'SpWaveFormatEx', 'DISPID_SPCIdToPhone', 'SRTReSent',
    'ISpRecoContext2', 'SDTRule', 'SPAS_RUN',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechGrammarRule',
    'DISPID_SPPsItem', 'SPWF_SRENGINE', 'SPEI_RESERVED2',
    'DISPID_SOTGetDescription', 'DISPID_SVSInputWordLength',
    'DISPID_SCSBaseStream', 'DISPID_SVGetAudioInputs',
    'SpeechEmulationCompareFlags', 'SVP_14', 'SPPS_NotOverriden',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIGetDisplayAttributes',
    'eLEXTYPE_RESERVED9', 'DISPID_SLWs_NewEnum', 'SPPS_RESERVED3',
    'DISPID_SABIBufferSize', 'SAFT16kHz8BitMono',
    'SpeechCategoryRecognizers', 'SpeechPropertyComplexResponseSpeed',
    'SPSHORTCUTTYPE', 'SGDSInactive', 'DISPID_SOTCSetId',
    'DISPID_SRCEPhraseStart', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechRecognizer', 'SPSEMANTICFORMAT', 'eLEXTYPE_USER_SHORTCUT',
    'SREBookmark', 'DISPID_SPIGetText', 'DISPID_SVAudioOutput',
    ...
    'SpeechRecoEvents', 'SpeechVisemeFeature',
    '__MIDL_IWinTypes_0009', 'SpCustomStream', 'SAFT22kHz16BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SABufferInfo',
    'DISPID_SMSSetData', 'SLTApp', 'SpeechGrammarState', 'SRSEDone',
    'DISPID_SRRDiscardResultInfo', 'SPRECOGNIZERSTATUS',
    'DISPID_SGRsFindRule', 'SPRECOSTATE', 'SPBO_AHEAD', 'SAFTDefault',
    'SRATopLevel', 'SRTStandard', 'eLEXTYPE_PRIVATE12',
    ...
    'DISPID_SRIsShared', 'SVSFParseAutodetect', 'DISPID_SAFType',
    'DISPID_SRDisplayUI', 'SAFT32kHz16BitStereo', 'DISPID_SVRate',
    'DISPID_SLAddPronunciation', 'DISPID_SVSpeakStream', 'SPPHRASE',
    'SPPS_Function', 'SAFT44kHz8BitStereo', 'DISPID_SGRSRule',
    'SPSFunction', 'SpeechGrammarTagDictation', 'SAFT16kHz8BitStereo',
    'DISPID_SOTDataKey', 'SpeechCategoryPhoneConverters',
    'DISPID_SRSAudioStatus', 'SPWORDLIST', 'SPEI_RESERVED5',
    'SVSFPurgeBeforeSpeak', 'SECFDefault', 'DISPID_SOTCategory',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCreateRecoContext',
    'ISpeechPhraseRules', 'DISPID_SBSSeek', 'DISPID_SASNonBlockingIO',
    'ISpeechXMLRecoResult', 'ISpDataKey',
    'ISpPhoneticAlphabetSelection', 'SRERequestUI',
    'SPEI_WORD_BOUNDARY', 'SPPHRASEELEMENT', 'DISPID_SRProfile',
    'SPEI_RECOGNITION', 'DISPID_SGRsCommit', 'DISPID_SMSADeviceId',
    'DISPID_SPRFirstElement', 'DISPID_SLPPhoneIds',
    'SpeechFormatType', 'ISpeechAudio', 'DISPID_SPACommit',
    'IEnumSpObjectTokens', 'SPLO_STATIC', 'ISpPhoneConverter',
    'SpeechLoadOption', 'SPAUDIOBUFFERINFO', 'ISpMMSysAudio',
    'DISPID_SDKEnumKeys', 'DISPID_SRGetPropertyString',
    'DISPID_SRCRequestedUIType', 'SPPS_Verb', 'DISPID_SRCEBookmark',
    'Speech_Max_Word_Length', 'SpeechDiscardType', 'DISPID_SOTCId',
    'ISpRecoCategory', 'SPFM_OPEN_READWRITE', 'SpSharedRecoContext',
    'DISPID_SOTSetId', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSAddRuleTransition', 'SGRSTTEpsilon',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechWaveFormatEx',
    'DISPID_SPRs_NewEnum', 'DISPID_SAFGuid', '_RemotableHandle',
    'SPFM_CREATE_ALWAYS', 'SREHypothesis', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT24kHz16BitMono', 'DISPID_SRGCmdSetRuleIdState',
    'ISpRecognizer3', 'SPAR_High', 'SPWORDPRONUNCIATIONLIST',
    'SAFT32kHz16BitMono', 'SDKLCurrentConfig', 'SpMemoryStream',
    'DISPID_SDKCreateKey', 'DISPID_SPRuleConfidence', 'eLEXTYPE_USER',
    'DISPID_SOTsItem', 'SRCS_Enabled', 'ISpeechPhraseRule',
    'ISpeechResourceLoader', 'SpMMAudioOut', 'SpeechVoiceEvents',
    'SpeechRunState', 'ISpVoice', 'SPGS_ENABLED',
    'SpeechCategoryRecoProfiles', 'SSTTDictation', 'SpMMAudioIn',
    'SGDisplay', 'DISPID_SRGReset', 'DISPID_SVSCurrentStreamNumber',
    'SRTSMLTimeout', 'DISPID_SVPriority', 'SAFTADPCM_44kHzStereo',
    'DISPID_SOTCEnumerateTokens', 'ISpeechVoiceStatus',
    'SPBO_TIME_UNITS', 'SPAR_Unknown', 'DISPID_SDKSetLongValue',
    'SPAS_STOP', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRSSupportedLanguages',
    'SpeechVoiceSkipTypeSentence', 'SAFT8kHz8BitMono',
    'SPEI_PHRASE_START', 'DISPID_SLPType', 'DISPID_SpeechVoiceStatus',
    'SREStreamEnd', 'SPXRO_SML', 'SPWORDTYPE', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechLexiconWords', 'SPEI_RESERVED1',
    'ISpeechRecoContext', 'DISPID_SPIEnginePrivateData',
    'ISpNotifyTranslator', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechRecognitionType', 'SpeechAllElements',
    'SAFTNonStandardFormat', 'DISPID_SVEEnginePrivate', 'SP_VISEME_4',
    'SINoSignal', 'DISPID_SPCLangId', 'DISPID_SPEsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPIReplacements', 'SGLexical',
    'eLEXTYPE_PRIVATE4', 'SVSFVoiceMask', 'SVP_1', 'SPCS_ENABLED',
    'ISequentialStream', 'DISPID_SWFEFormatTag', 'SPDKL_LocalMachine',
    'DISPID_SGRsCommitAndSave', 'SREPropertyNumChange',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPEs_NewEnum',
    'DISPID_SPIStartTime', 'SDTAudio', 'SFTSREngine',
    'SREStreamStart', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSHT_EMAIL', 'SRTExtendableParse', 'SRSInactive',
    'DISPID_SRRecognizer', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SGRSTsCount', 'DISPID_SpeechPhraseReplacements',
    'SPGS_DISABLED', 'SpeechWordPronounceable', 'SPEI_MAX_SR',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLPs_NewEnum',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFIsFilename',
    'eLEXTYPE_PRIVATE20', 'SpeechRecoContextState',
    'DISPID_SRCEAudioLevel', 'ISpRecoContext', 'SDTAll',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SABufferNotifySize',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechObjectTokenCategory',
    'SRAExport', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPPEngineConfidence', 'ISpeechPhraseElements',
    'DISPID_SpeechCustomStream', 'DISPID_SRRGetXMLErrorInfo',
    'SPEI_ADAPTATION', 'SPRULESTATE', 'SpeechAudioVolume',
    'DISPID_SGRId', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPWT_DISPLAY', 'SPCT_SLEEP', 'SpeechTokenKeyFiles',
    'ISpeechPhraseInfoBuilder', 'SVSFDefault',
    'DISPID_SGRSTNextState', 'SpeechAudioState',
    'IInternetSecurityManager', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SASState', 'SPDKL_DefaultLocation',
    'SpeechStreamFileMode', 'eLEXTYPE_RESERVED6', 'SECLowConfidence',
    'DISPID_SVStatus', 'SGSEnabled', 'DISPID_SPRuleId',
    'SPEI_TTS_AUDIO_LEVEL', 'SECFNoSpecialChars',
    'SpeechAudioFormatType', 'SVSFNLPSpeakPunc', 'SRSEIsSpeaking',
    '_ISpeechVoiceEvents', 'SPVPRI_NORMAL'
]
